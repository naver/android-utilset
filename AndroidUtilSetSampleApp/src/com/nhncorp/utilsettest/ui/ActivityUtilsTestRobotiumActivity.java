...
@SuppressLint("NewApi")
public class ActivityUtilsTestRobotiumActivity extends FragmentActivity implements ActionBar.TabListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		viewPager.setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
			...
			public void onPageSelected(int position) {
				// TODO Auto-generated method stub
				if (position == 0) {
					ActivityUtils.setScreenOn(ActivityUtilsTestRobotiumActivity.this);
				}
				else if (position == 1) {
					ActivityUtils.clearScreenOn(ActivityUtilsTestRobotiumActivity.this);
				}
